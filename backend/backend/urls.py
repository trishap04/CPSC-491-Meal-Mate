...
urlpatterns = [
    ...
    path('forgot-password.html', ensure_csrf_cookie(TemplateView.as_view(template_name='album/forgot-password.html')), name='forgot_password_html'),
    path('forgot-password/', ensure_csrf_cookie(TemplateView.as_view(template_name='album/forgot-password.html')), name='forgot_password'),
    path('reset-password.html', ensure_csrf_cookie(TemplateView.as_view(template_name='album/reset-password.html')), name='reset_password_html'),
    path('reset-password/', ensure_csrf_cookie(TemplateView.as_view(template_name='album/reset-password.html')), name='reset_password'),
    ...
    path('settings.html', ensure_csrf_cookie(TemplateView.as_view(template_name='album/settings.html')), name='settings_html'),
    path('settings/', ensure_csrf_cookie(TemplateView.as_view(template_name='album/settings.html')), name='settings'),
